...
def run_heartbeat_model(
    ...
    *,
    ...
    # This runtime is called by unattended heartbeat work. Effects belong to
    # deterministic pre/post scripts, never to a model process. Preserve the
    # argument for API compatibility but make the safety boundary authoritative
    ...
    if primary_only:
        runtime_model = (
            ...
            else str(default_model or "").strip()
        )
    elif requested == "gpt":
        runtime_model = ""
