...
|---|---|---|---|---|---|---|---|
| `component:admin` | runtime-component | **keep** | `components.yaml:106` | `core/components.py:586` | python3 -m core.components --json | `tests/test_admin.py:51`, `tests/test_admin_api.py:582`, `tests/test_admin_destructive.py:109` | - |
| `component:bot` | runtime-component | **keep** | `components.yaml:45` | `core/components.py:584` | python3 -m core.components --json | `tests/test_components_gating.py:380`, `tests/test_daemon_audit_fixes.py:520`, `tests/test_delegation_verify.py:274` | - |
| `component:caffeinate-launchd` | runtime-component | **keep** | `components.yaml:138` | `core/components.py:593` | python3 -m core.components --json | `tests/test_restart_loop_regression.py:196` | - |
| `component:companion-voice` | runtime-component | **keep** | `components.yaml:161` | `core/components.py:587` | python3 -m core.components --json | `tests/test_companion.py:197` | - |
| `component:conversation-audit` | runtime-component | **keep** | `components.yaml:153` | `core/components.py:590` | python3 -m core.components --json | `tests/test_components_gating.py:128`, `tests/test_reliability_v2.py:27` | - |
| `component:daemon` | runtime-component | **keep** | `components.yaml:38` | `core/components.py:584` | python3 -m core.components --json | `tests/test_admin.py:135`, `tests/test_admin_api.py:352`, `tests/test_anchor_guard.py:84` | - |
| `component:daemon-launchd` | runtime-component | **keep** | `components.yaml:126` | `core/components.py:593` | python3 -m core.components --json | `tests/test_install_flow.py:231`, `tests/test_restart_loop_regression.py:194` | - |
| `component:dashboard` | runtime-component | **keep** | `components.yaml:113` | `core/components.py:586` | python3 -m core.components --json | `tests/test_capability_contracts.py:196`, `tests/test_components_gating.py:43`, `tests/test_daemon_audit_fixes.py:520` | - |
| `component:dashboard-launchd` | runtime-component | **keep** | `components.yaml:120` | `core/components.py:593` | python3 -m core.components --json | `tests/test_install_flow.py:260`, `tests/test_restart_loop_regression.py:73` | - |
| `component:ef-stream` | runtime-component | **keep** | `components.yaml:88` | `core/components.py:588` | python3 -m core.components --json | `tests/test_components_gating.py:29`, `tests/test_daemon_audit_fixes.py:469`, `tests/test_reliability_v2.py:25` | - |
| `component:external-deadman` | runtime-component | **keep** | `components.yaml:132` | `core/components.py:589` | python3 -m core.components --json | `tests/test_deadman.py:82` | - |
| `component:heartbeat-loop` | runtime-component | **keep** | `components.yaml:51` | `core/components.py:585` | python3 -m core.components --json | `tests/test_daemon_audit_fixes.py:520`, `tests/test_deploy.py:35`, `tests/test_iteration_loop.py:936` | - |
| `component:heartbeat-tasks` | runtime-component | **keep** | `components.yaml:58` | `core/components.py:591` | python3 -m core.components --json | `tests/test_components_heartbeat_tasks.py:171` | - |
| `component:lark-sidecar` | runtime-component | **keep** | `components.yaml:98` | `core/components.py:585` | python3 -m core.components --json | `tests/test_components_gating.py:80`, `tests/test_daemon_audit_fixes.py:520`, `tests/test_reliability_v2.py:25` | - |
| `component:session-backup` | runtime-component | **keep** | `components.yaml:145` | `core/components.py:587` | python3 -m core.components --json | `tests/test_components_gating.py:464`, `tests/test_reliability_v2.py:26` | - |
| `component:taskline` | runtime-component | **keep** | `components.yaml:33` | `core/components.py:594` | python3 -m core.components --json | `tests/test_components_gating.py:395`, `tests/test_delegation_reconcile.py:196`, `tests/test_install_flow.py:223` | - |
| `component:unified-delivery` | runtime-component | **keep** | `components.yaml:73` | `core/components.py:592` | python3 -m core.components --json | `tests/test_components_gating.py:258` | - |
...
| `cli:core.components` | core-cli | **keep** | `core/components.py:659` | `core/components.py:659` | python3 -m core.components | `tests/test_companion.py:197`, `tests/test_components_gating.py:35`, `tests/test_components_heartbeat_tasks.py:167` | - |
...
| `cli:core.heartbeat_loop` | core-cli | **keep** | `core/heartbeat_loop.py:1931` | `core/heartbeat_loop.py:1931` | python3 -m core.heartbeat_loop | `tests/test_heartbeat_loop.py:99`, `tests/test_import_graph.py:157`, `tests/test_integration.py:67` | - |
...
| `cli:core.memorial` | core-cli | **keep** | `core/memorial.py:3476` | `core/memorial.py:3476` | python3 -m core.memorial | `tests/test_absence.py:128`, `tests/test_attention_roi.py:134`, `tests/test_bot_trust_boundary.py:63` | - |
...
| `cli:core.presence` | core-cli | **keep** | `core/presence.py:222` | `core/presence.py:222` | python3 -m core.presence | `tests/test_presence.py:56` | - |
