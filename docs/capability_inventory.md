...
| `heartbeat:daily-reflect` | heartbeat-task | **keep** | `HEARTBEAT.md:969` | `tasks/daily_reflect_pre.sh:1`, `tasks/daily_reflect_post.py:1` | python3 -m core.heartbeat_loop | `tests/test_card_residue_leak.py:98`, `tests/test_dashboard_routes.py:1074`, `tests/test_heartbeat_loop.py:133` | - |
...
| `heartbeat:mail-triage` | heartbeat-task | **keep** | `HEARTBEAT.md:317` | `tasks/mail_triage_pre.sh:1`, `tasks/mail_triage_post.py:1` | python3 -m core.heartbeat_loop | `tests/test_delivery_and_quiet_hours.py:108`, `tests/test_heartbeat.py:108`, `tests/test_heartbeat_loop.py:109` | - |
...
| `cli:core.delivery` | core-cli | **keep** | `core/delivery.py:1719` | `core/delivery.py:1719` | python3 -m core.delivery | `tests/test_admin_api.py:403`, `tests/test_admin_destructive.py:262`, `tests/test_bot_trust_boundary.py:60` | - |
