...
| `heartbeat:daily-reflect` | heartbeat-task | **keep** | `HEARTBEAT.md:968` | `tasks/daily_reflect_pre.sh:1`, `tasks/daily_reflect_post.py:1` | python3 -m core.heartbeat_loop | `tests/test_card_residue_leak.py:98`, `tests/test_dashboard_routes.py:1074`, `tests/test_heartbeat_loop.py:132` | - |
...
| `heartbeat:mail-triage` | heartbeat-task | **keep** | `HEARTBEAT.md:317` | `tasks/mail_triage_pre.sh:1`, `tasks/mail_triage_post.py:1` | python3 -m core.heartbeat_loop | `tests/test_delivery_and_quiet_hours.py:103`, `tests/test_heartbeat.py:107`, `tests/test_heartbeat_loop.py:108` | - |
...
| `cli:core.provider_health` | core-cli | **keep** | `core/provider_health.py:810` | `core/provider_health.py:810` | python3 -m core.provider_health | `tests/test_dashboard_routes.py:1599`, `tests/test_heartbeat.py:337`, `tests/test_provider_continuity_e2e.py:413` | - |
