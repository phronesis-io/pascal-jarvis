...
| `cli:core.heartbeat_loop` | core-cli | **keep** | `core/heartbeat_loop.py:1933` | `core/heartbeat_loop.py:1933` | python3 -m core.heartbeat_loop | `tests/test_daemon_regressions.py:128`, `tests/test_heartbeat_loop.py:99`, `tests/test_import_graph.py:157` | - |
