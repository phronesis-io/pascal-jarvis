...
| `cli:core.memorial` | core-cli | **keep** | `core/memorial.py:3672` | `core/memorial.py:3672` | python3 -m core.memorial | `tests/test_absence.py:128`, `tests/test_attention_roi.py:134`, `tests/test_bot_trust_boundary.py:63` | - |
