...
| `heartbeat:memory-daily` | heartbeat-task | **keep** | `HEARTBEAT.md:647` | `tasks/memory_daily_pre.sh:1`, `tasks/memory_daily_post.py:1` | python3 -m core.heartbeat_loop | `tests/test_heartbeat.py:443`, `tests/test_memory_audit_fixes.py:236` | - |
| `heartbeat:memory-hourly` | heartbeat-task | **keep** | `HEARTBEAT.md:637` | `tasks/memory_hourly_pre.sh:1`, `tasks/memory_hourly_post.py:1` | python3 -m core.heartbeat_loop | `tests/test_brain_health.py:50`, `tests/test_heartbeat.py:427`, `tests/test_heartbeat_regressions.py:275` | - |
| `heartbeat:memory-tidy` | heartbeat-task | **keep** | `HEARTBEAT.md:800` | `tasks/memory_tidy_pre.sh:1`, `tasks/memory_tidy_post.py:1` | python3 -m core.heartbeat_loop | `tests/test_components_heartbeat_tasks.py:89`, `tests/test_heartbeat.py:1420`, `tests/test_memory.py:592` | - |
...
| `heartbeat:personal-site` | heartbeat-task | **keep** | `HEARTBEAT.md:1207` | `tasks/personal_site_pre.sh:1` | python3 -m core.heartbeat_loop | `tests/test_heartbeat.py:1419` | - |
...
| `heartbeat:self-diagnostic` | heartbeat-task | **keep** | `HEARTBEAT.md:1186` | `tasks/self_diagnostic_pre.sh:1`, `tasks/self_diagnostic_post.py:1` | python3 -m core.heartbeat_loop | `tests/test_components_heartbeat_tasks.py:92`, `tests/test_daemon_audit_fixes.py:209`, `tests/test_heartbeat.py:819` | - |
...
| `heartbeat:thinking-review` | heartbeat-task | **keep** | `HEARTBEAT.md:1034` | `tasks/thinking_review_post.py:1` | python3 -m core.heartbeat_loop | `tests/test_heartbeat.py:730` | - |
...
| `cli:core.model_fallback` | core-cli | **keep** | `core/model_fallback.py:349` | `core/model_fallback.py:349` | python3 -m core.model_fallback | `tests/test_aux_model.py:20`, `tests/test_heartbeat.py:281`, `tests/test_model_fallback.py:84` | - |
| `cli:core.openai_fallback` | core-cli | **keep** | `core/openai_fallback.py:522` | `core/openai_fallback.py:522` | python3 -m core.openai_fallback | `tests/test_aux_model.py:86`, `tests/test_heartbeat.py:291`, `tests/test_model_fallback.py:278` | - |
...
| `cli:core.provider_health` | core-cli | **keep** | `core/provider_health.py:810` | `core/provider_health.py:810` | python3 -m core.provider_health | `tests/test_dashboard_routes.py:1599`, `tests/test_heartbeat.py:283`, `tests/test_provider_continuity_e2e.py:413` | - |
...
| `cli:core.sched_events` | core-cli | **keep** | `core/sched_events.py:286` | `core/sched_events.py:286` | python3 -m core.sched_events | `tests/test_admin_api.py:370`, `tests/test_dashboard_routes.py:313`, `tests/test_heartbeat.py:1181` | - |
...
| `cli:core.watermarks` | core-cli | **keep** | `core/watermarks.py:263` | `core/watermarks.py:263` | python3 -m core.watermarks | `tests/test_reliability_v2.py:393` | - |
