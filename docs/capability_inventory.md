...
| `heartbeat:eigenflux-preinstall` | heartbeat-task | **keep** | `HEARTBEAT.md:1155` | `tasks/eigenflux_preinstall_pre.sh:1` | python3 -m core.heartbeat_loop | `tests/test_eigenflux_dashboard.py:148`, `tests/test_eigenflux_skill_contracts.py:127`, `tests/test_heartbeat.py:1307` | - |
...
| `heartbeat:memory-daily` | heartbeat-task | **keep** | `HEARTBEAT.md:647` | `tasks/memory_daily_pre.sh:1`, `tasks/memory_daily_post.py:1` | python3 -m core.heartbeat_loop | `tests/test_heartbeat.py:606`, `tests/test_memory_audit_fixes.py:236` | - |
| `heartbeat:memory-hourly` | heartbeat-task | **keep** | `HEARTBEAT.md:637` | `tasks/memory_hourly_pre.sh:1`, `tasks/memory_hourly_post.py:1` | python3 -m core.heartbeat_loop | `tests/test_brain_health.py:50`, `tests/test_heartbeat.py:590`, `tests/test_heartbeat_regressions.py:275` | - |
...
| `heartbeat:personal-site` | heartbeat-task | **keep** | `HEARTBEAT.md:1210` | `tasks/personal_site_pre.sh:1` | python3 -m core.heartbeat_loop | `tests/test_heartbeat.py:1594` | - |
...
| `heartbeat:routine-run` | heartbeat-task | **keep** | `HEARTBEAT.md:765` | `tasks/routine_run_pre.sh:1`, `tasks/routine_run_post.py:1` | python3 -m core.heartbeat_loop | `tests/test_heartbeat_regressions.py:227`, `tests/test_routines.py:475` | - |
| `heartbeat:self-diagnostic` | heartbeat-task | **keep** | `HEARTBEAT.md:1189` | `tasks/self_diagnostic_pre.sh:1`, `tasks/self_diagnostic_post.py:1` | python3 -m core.heartbeat_loop | `tests/test_components_heartbeat_tasks.py:92`, `tests/test_daemon_audit_fixes.py:209`, `tests/test_heartbeat.py:982` | - |
...
| `heartbeat:thinking-review` | heartbeat-task | **keep** | `HEARTBEAT.md:1035` | `tasks/thinking_review_post.py:1` | python3 -m core.heartbeat_loop | `tests/test_heartbeat.py:893` | - |
...
| `cli:core.sched_events` | core-cli | **keep** | `core/sched_events.py:286` | `core/sched_events.py:286` | python3 -m core.sched_events | `tests/test_admin_api.py:370`, `tests/test_dashboard_routes.py:313`, `tests/test_heartbeat.py:1356` | - |
