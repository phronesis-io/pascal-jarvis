...
| `heartbeat:eigenflux-preinstall` | heartbeat-task | **keep** | `HEARTBEAT.md:1155` | `tasks/eigenflux_preinstall_pre.sh:1` | python3 -m core.heartbeat_loop | `tests/test_eigenflux_dashboard.py:147`, `tests/test_eigenflux_skill_contracts.py:130` | - |
...
| `cli:core.cross_session_index` | core-cli | **keep** | `core/cross_session_index.py:563` | `core/cross_session_index.py:563` | python3 -m core.cross_session_index | `tests/test_cross_session_index.py:55` | - |
