...
| `heartbeat:personal-site` | heartbeat-task | **keep** | `HEARTBEAT.md:1236` | `tasks/personal_site_pre.sh:1` | python3 -m core.heartbeat_loop | `tests/test_heartbeat.py:1653` | - |
...
| `cli:core.ef_stream_loop` | core-cli | **keep** | `core/ef_stream_loop.py:1342` | `core/ef_stream_loop.py:1342` | python3 -m core.ef_stream_loop | `tests/test_components_gating.py:31`, `tests/test_restart_loop_regression.py:1117` | - |
