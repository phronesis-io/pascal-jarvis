...
|---|---|---|---|---|---|---|---|
| `component:admin` | runtime-component | **keep** | `components.yaml:106` | `core/components.py:534` | python3 -m core.components --json | `tests/test_admin.py:51`, `tests/test_admin_api.py:582`, `tests/test_admin_destructive.py:109` | - |
| `component:bot` | runtime-component | **keep** | `components.yaml:45` | `core/components.py:532` | python3 -m core.components --json | `tests/test_components_gating.py:380`, `tests/test_daemon_audit_fixes.py:520`, `tests/test_delegation_verify.py:274` | - |
| `component:caffeinate-launchd` | runtime-component | **keep** | `components.yaml:138` | `core/components.py:541` | python3 -m core.components --json | `tests/test_restart_loop_regression.py:196` | - |
| `component:companion-voice` | runtime-component | **keep** | `components.yaml:161` | `core/components.py:535` | python3 -m core.components --json | `tests/test_companion.py:197` | - |
| `component:conversation-audit` | runtime-component | **keep** | `components.yaml:153` | `core/components.py:538` | python3 -m core.components --json | `tests/test_components_gating.py:128`, `tests/test_reliability_v2.py:27` | - |
| `component:daemon` | runtime-component | **keep** | `components.yaml:38` | `core/components.py:532` | python3 -m core.components --json | `tests/test_admin.py:135`, `tests/test_admin_api.py:352`, `tests/test_anchor_guard.py:84` | - |
| `component:daemon-launchd` | runtime-component | **keep** | `components.yaml:126` | `core/components.py:541` | python3 -m core.components --json | `tests/test_install_flow.py:231`, `tests/test_restart_loop_regression.py:194` | - |
| `component:dashboard` | runtime-component | **keep** | `components.yaml:113` | `core/components.py:534` | python3 -m core.components --json | `tests/test_capability_contracts.py:196`, `tests/test_components_gating.py:43`, `tests/test_daemon_audit_fixes.py:520` | - |
| `component:dashboard-launchd` | runtime-component | **keep** | `components.yaml:120` | `core/components.py:541` | python3 -m core.components --json | `tests/test_install_flow.py:260`, `tests/test_restart_loop_regression.py:73` | - |
| `component:ef-stream` | runtime-component | **keep** | `components.yaml:88` | `core/components.py:536` | python3 -m core.components --json | `tests/test_components_gating.py:29`, `tests/test_daemon_audit_fixes.py:469`, `tests/test_reliability_v2.py:25` | - |
| `component:external-deadman` | runtime-component | **keep** | `components.yaml:132` | `core/components.py:537` | python3 -m core.components --json | `tests/test_deadman.py:82` | - |
| `component:heartbeat-loop` | runtime-component | **keep** | `components.yaml:51` | `core/components.py:533` | python3 -m core.components --json | `tests/test_daemon_audit_fixes.py:520`, `tests/test_deploy.py:35`, `tests/test_iteration_loop.py:936` | - |
| `component:heartbeat-tasks` | runtime-component | **keep** | `components.yaml:58` | `core/components.py:539` | python3 -m core.components --json | `tests/test_components_heartbeat_tasks.py:171` | - |
| `component:lark-sidecar` | runtime-component | **keep** | `components.yaml:98` | `core/components.py:533` | python3 -m core.components --json | `tests/test_components_gating.py:80`, `tests/test_daemon_audit_fixes.py:520`, `tests/test_reliability_v2.py:25` | - |
| `component:session-backup` | runtime-component | **keep** | `components.yaml:145` | `core/components.py:535` | python3 -m core.components --json | `tests/test_reliability_v2.py:26` | - |
| `component:taskline` | runtime-component | **keep** | `components.yaml:33` | `core/components.py:542` | python3 -m core.components --json | `tests/test_components_gating.py:395`, `tests/test_delegation_reconcile.py:196`, `tests/test_install_flow.py:223` | - |
| `component:unified-delivery` | runtime-component | **keep** | `components.yaml:73` | `core/components.py:540` | python3 -m core.components --json | `tests/test_components_gating.py:258` | - |
| `heartbeat:activity-log` | heartbeat-task | **keep** | `HEARTBEAT.md:907` | `tasks/activity_log_pre.sh:1`, `tasks/activity_log_post.py:1` | python3 -m core.heartbeat_loop | `tests/test_components_heartbeat_tasks.py:83`, `tests/test_memory.py:140` | - |
...
| `heartbeat:cross-session-sync` | heartbeat-task | **keep** | `HEARTBEAT.md:823` | `tasks/cross_session_pre.sh:1`, `tasks/cross_session_post.py:1` | python3 -m core.heartbeat_loop | `tests/test_card_delivery_closure.py:309`, `tests/test_conversation_audit.py:368`, `tests/test_cross_session_memory_e2e.py:53` | - |
| `heartbeat:daily-plan` | heartbeat-task | **keep** | `HEARTBEAT.md:929` | `tasks/daily_plan_pre.sh:1`, `tasks/daily_plan_post.py:1` | python3 -m core.heartbeat_loop | `tests/test_card.py:176`, `tests/test_daily_plan_post.py:42`, `tests/test_delivery_and_quiet_hours.py:419` | - |
| `heartbeat:daily-reflect` | heartbeat-task | **keep** | `HEARTBEAT.md:969` | `tasks/daily_reflect_pre.sh:1`, `tasks/daily_reflect_post.py:1` | python3 -m core.heartbeat_loop | `tests/test_card_residue_leak.py:98`, `tests/test_dashboard_routes.py:1074`, `tests/test_heartbeat_loop.py:158` | - |
| `heartbeat:delegation-reconcile` | heartbeat-task | **keep** | `HEARTBEAT.md:1072` | `tasks/delegation_reconcile_pre.sh:1` | python3 -m core.heartbeat_loop | `tests/test_delegation_projection.py:247`, `tests/test_delegation_reconcile.py:429`, `tests/test_eigenflux_friend_actions.py:221` | - |
...
| `heartbeat:eigenflux-friends` | heartbeat-task | **keep** | `HEARTBEAT.md:266` | `tasks/eigenflux_friends_pre.sh:1`, `tasks/eigenflux_friends_post.py:1` | python3 -m core.heartbeat_loop | `tests/test_card_delivery_closure.py:251`, `tests/test_ef_stream_loop.py:71`, `tests/test_eigenflux_dashboard.py:153` | - |
| `heartbeat:eigenflux-preinstall` | heartbeat-task | **keep** | `HEARTBEAT.md:1156` | `tasks/eigenflux_preinstall_pre.sh:1` | python3 -m core.heartbeat_loop | `tests/test_eigenflux_dashboard.py:148`, `tests/test_eigenflux_skill_contracts.py:127`, `tests/test_heartbeat.py:1333` | - |
...
| `heartbeat:engagement-analyze` | heartbeat-task | **keep** | `HEARTBEAT.md:868` | `tasks/engagement_analyze_pre.sh:1`, `tasks/engagement_analyze_post.py:1` | python3 -m core.heartbeat_loop | `tests/test_engagement.py:171`, `tests/test_interaction_quality_p0.py:170` | - |
| `heartbeat:exercise-week` | heartbeat-task | **keep** | `HEARTBEAT.md:1273` | `tasks/exercise_week_pre.sh:1`, `tasks/exercise_week_post.py:1` | python3 -m core.heartbeat_loop | `tests/test_lifelog.py:209`, `tests/test_memorial.py:1692` | - |
...
| `heartbeat:iteration-observe` | heartbeat-task | **keep** | `HEARTBEAT.md:1081` | `tasks/iteration_observe_pre.sh:1` | python3 -m core.heartbeat_loop | `tests/test_heartbeat_audit_fixes.py:107` | - |
| `heartbeat:log-maintenance` | heartbeat-task | **keep** | `HEARTBEAT.md:1090` | `tasks/log_maintenance_pre.sh:1` | python3 -m core.heartbeat_loop | `tests/test_heartbeat_audit_fixes.py:108`, `tests/test_log_maintenance.py:32` | - |
| `heartbeat:mail-triage` | heartbeat-task | **keep** | `HEARTBEAT.md:317` | `tasks/mail_triage_pre.sh:1`, `tasks/mail_triage_post.py:1` | python3 -m core.heartbeat_loop | `tests/test_delivery_and_quiet_hours.py:108`, `tests/test_heartbeat.py:108`, `tests/test_heartbeat_loop.py:134` | - |
| `heartbeat:memorial-escrow` | heartbeat-task | **keep** | `HEARTBEAT.md:1098` | `tasks/memorial_escrow_pre.sh:1` | python3 -m core.heartbeat_loop | `tests/test_memorial.py:656`, `tests/test_memorial_escrow.py:170`, `tests/test_no_dead_ends.py:66` | - |
...
| `heartbeat:memory-daily` | heartbeat-task | **keep** | `HEARTBEAT.md:647` | `tasks/memory_daily_pre.sh:1`, `tasks/memory_daily_post.py:1` | python3 -m core.heartbeat_loop | `tests/test_heartbeat.py:632`, `tests/test_memory_audit_fixes.py:236` | - |
| `heartbeat:memory-hourly` | heartbeat-task | **keep** | `HEARTBEAT.md:637` | `tasks/memory_hourly_pre.sh:1`, `tasks/memory_hourly_post.py:1` | python3 -m core.heartbeat_loop | `tests/test_brain_health.py:50`, `tests/test_heartbeat.py:616`, `tests/test_heartbeat_regressions.py:275` | - |
| `heartbeat:memory-tidy` | heartbeat-task | **keep** | `HEARTBEAT.md:801` | `tasks/memory_tidy_pre.sh:1`, `tasks/memory_tidy_post.py:1` | python3 -m core.heartbeat_loop | `tests/test_components_heartbeat_tasks.py:89`, `tests/test_heartbeat.py:129`, `tests/test_memory.py:592` | - |
...
| `heartbeat:metrics-digest` | heartbeat-task | **keep** | `HEARTBEAT.md:563` | `tasks/metrics_digest_pre.sh:1`, `tasks/metrics_digest_post.py:1` | python3 -m core.heartbeat_loop | `tests/test_card_delivery_closure.py:70`, `tests/test_companion.py:100`, `tests/test_dashboard_routes.py:1022` | - |
| `heartbeat:morning-anchor` | heartbeat-task | **keep** | `HEARTBEAT.md:468` | `tasks/morning_anchor_pre.sh:1`, `tasks/morning_anchor_post.py:1` | python3 -m core.heartbeat_loop | `tests/test_delivery_pipeline.py:181`, `tests/test_lifelog.py:233`, `tests/test_presence.py:213` | - |
...
| `heartbeat:personal-site` | heartbeat-task | **keep** | `HEARTBEAT.md:1211` | `tasks/personal_site_pre.sh:1` | python3 -m core.heartbeat_loop | `tests/test_heartbeat.py:1620` | - |
| `heartbeat:phronesis-monitor` | heartbeat-task | **keep** | `HEARTBEAT.md:1004` | `tasks/phronesis_monitor_pre.sh:1`, `tasks/phronesis_monitor_post.py:1` | python3 -m core.heartbeat_loop | `tests/test_card_delivery_closure.py:70`, `tests/test_delivery_and_quiet_hours.py:361` | - |
| `heartbeat:provider-canary` | heartbeat-task | **keep** | `HEARTBEAT.md:1109` | `tasks/provider_canary_pre.sh:1` | python3 -m core.heartbeat_loop | `tests/test_heartbeat_audit_fixes.py:109`, `tests/test_reliability_v2.py:453` | - |
...
| `heartbeat:repos-sync` | heartbeat-task | **keep** | `HEARTBEAT.md:1118` | `tasks/repos_sync_pre.sh:1` | python3 -m core.heartbeat_loop | `tests/test_admin_api.py:325`, `tests/test_card_delivery_closure.py:70`, `tests/test_dashboard_routes.py:818` | - |
| `heartbeat:routine-run` | heartbeat-task | **keep** | `HEARTBEAT.md:765` | `tasks/routine_run_pre.sh:1`, `tasks/routine_run_post.py:1` | python3 -m core.heartbeat_loop | `tests/test_heartbeat.py:137`, `tests/test_heartbeat_regressions.py:227`, `tests/test_routines.py:475` | - |
| `heartbeat:self-diagnostic` | heartbeat-task | **keep** | `HEARTBEAT.md:1190` | `tasks/self_diagnostic_pre.sh:1`, `tasks/self_diagnostic_post.py:1` | python3 -m core.heartbeat_loop | `tests/test_components_heartbeat_tasks.py:92`, `tests/test_daemon_audit_fixes.py:209`, `tests/test_heartbeat.py:1008` | - |
...
| `heartbeat:thinking-review` | heartbeat-task | **keep** | `HEARTBEAT.md:1036` | `tasks/thinking_review_post.py:1` | python3 -m core.heartbeat_loop | `tests/test_heartbeat.py:919` | - |
| `heartbeat:weekly-review` | heartbeat-task | **keep** | `HEARTBEAT.md:1224` | `tasks/weekly_review_pre.sh:1`, `tasks/weekly_review_post.py:1` | python3 -m core.heartbeat_loop | `tests/test_heartbeat_audit_fixes.py:102`, `tests/test_weekly_review_post.py:48` | - |
...
| `cli:core.components` | core-cli | **keep** | `core/components.py:607` | `core/components.py:607` | python3 -m core.components | `tests/test_companion.py:197`, `tests/test_components_gating.py:35`, `tests/test_components_heartbeat_tasks.py:167` | - |
| `cli:core.conversation_audit` | core-cli | **keep** | `core/conversation_audit.py:1094` | `core/conversation_audit.py:1094` | python3 -m core.conversation_audit | `tests/test_components_gating.py:101`, `tests/test_components_post_wake_grace.py:159`, `tests/test_conversation_audit.py:14` | - |
...
| `cli:core.deadman` | core-cli | **keep** | `core/deadman.py:161` | `core/deadman.py:161` | python3 -m core.deadman | `tests/test_daemon_regressions.py:52`, `tests/test_deadman.py:23` | - |
...
| `cli:core.delivery` | core-cli | **keep** | `core/delivery.py:1796` | `core/delivery.py:1796` | python3 -m core.delivery | `tests/test_admin_api.py:403`, `tests/test_admin_destructive.py:262`, `tests/test_bot_trust_boundary.py:60` | - |
...
| `cli:core.ef_stream_loop` | core-cli | **keep** | `core/ef_stream_loop.py:846` | `core/ef_stream_loop.py:846` | python3 -m core.ef_stream_loop | `tests/test_components_gating.py:31` | - |
...
| `cli:core.heartbeat_loop` | core-cli | **keep** | `core/heartbeat_loop.py:1925` | `core/heartbeat_loop.py:1925` | python3 -m core.heartbeat_loop | `tests/test_heartbeat_loop.py:99`, `tests/test_import_graph.py:157`, `tests/test_integration.py:67` | - |
...
| `cli:core.memorial` | core-cli | **keep** | `core/memorial.py:3476` | `core/memorial.py:3476` | python3 -m core.memorial | `tests/test_attention_roi.py:134`, `tests/test_bot_trust_boundary.py:63`, `tests/test_capability_contracts.py:185` | - |
...
| `cli:core.presence` | core-cli | **keep** | `core/presence.py:244` | `core/presence.py:244` | python3 -m core.presence | `tests/test_presence.py:56` | - |
...
| `cli:core.selfmon` | core-cli | **keep** | `core/selfmon.py:634` | `core/selfmon.py:634` | python3 -m core.selfmon | `tests/test_delivery_pipeline.py:154`, `tests/test_memorial.py:127`, `tests/test_memorial_docket_quality.py:83` | - |
...
| `route:page:/eigenflux` | dashboard-page | **keep** | `dashboard/pages/eigenflux.py:219` | `dashboard/pages/eigenflux.py:220` | /eigenflux | `tests/test_capability_contracts.py:185` | - |
