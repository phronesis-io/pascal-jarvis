...
| `heartbeat:daily-reflect` | heartbeat-task | **keep** | `HEARTBEAT.md:996` | `tasks/daily_reflect_pre.sh:1`, `tasks/daily_reflect_post.py:1` | python3 -m core.heartbeat_loop | `tests/test_card_residue_leak.py:98`, `tests/test_heartbeat_loop.py:158`, `tests/test_journal_capture.py:70` | - |
