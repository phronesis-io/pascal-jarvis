...
| `heartbeat:activity-log` | heartbeat-task | **keep** | `HEARTBEAT.md:553` | `tasks/activity_log_pre.sh:1`, `tasks/activity_log_post.py:1` | python3 -m core.heartbeat_loop | `tests/test_components_heartbeat_tasks.py:83`, `tests/test_heartbeat.py:177`, `tests/test_memory.py:140` | - |
...
| `heartbeat:daily-reflect` | heartbeat-task | **keep** | `HEARTBEAT.md:616` | `tasks/daily_reflect_pre.sh:1`, `tasks/daily_reflect_post.py:1` | python3 -m core.heartbeat_loop | `tests/test_card_residue_leak.py:98`, `tests/test_delivery_pipeline.py:961`, `tests/test_heartbeat_loop.py:191` | - |
...
| `heartbeat:eigenflux-preinstall` | heartbeat-task | **keep** | `HEARTBEAT.md:779` | `tasks/eigenflux_preinstall_pre.sh:1` | python3 -m core.heartbeat_loop | `tests/test_eigenflux_skill_contracts.py:136`, `tests/test_heartbeat.py:2050`, `tests/test_interaction_quality_p0.py:228` | - |
...
| `heartbeat:mail-triage` | heartbeat-task | **keep** | `HEARTBEAT.md:146` | `tasks/mail_triage_pre.sh:1`, `tasks/mail_triage_post.py:1` | python3 -m core.heartbeat_loop | `tests/test_delivery_and_quiet_hours.py:106`, `tests/test_heartbeat.py:137`, `tests/test_heartbeat_loop.py:167` | - |
...
| `heartbeat:memory-daily` | heartbeat-task | **keep** | `HEARTBEAT.md:357` | `tasks/memory_daily_pre.sh:1`, `tasks/memory_daily_post.py:1` | python3 -m core.heartbeat_loop | `tests/test_heartbeat.py:1349`, `tests/test_memory_audit_fixes.py:236` | - |
| `heartbeat:memory-hourly` | heartbeat-task | **keep** | `HEARTBEAT.md:347` | `tasks/memory_hourly_pre.sh:1`, `tasks/memory_hourly_post.py:1` | python3 -m core.heartbeat_loop | `tests/test_brain_health.py:56`, `tests/test_heartbeat.py:1333`, `tests/test_heartbeat_regressions.py:319` | - |
| `heartbeat:memory-tidy` | heartbeat-task | **keep** | `HEARTBEAT.md:483` | `tasks/memory_tidy_pre.sh:1`, `tasks/memory_tidy_post.py:1` | python3 -m core.heartbeat_loop | `tests/test_components_heartbeat_tasks.py:89`, `tests/test_heartbeat.py:158`, `tests/test_memory.py:592` | - |
...
| `heartbeat:phronesis-monitor` | heartbeat-task | **keep** | `HEARTBEAT.md:651` | `tasks/phronesis_monitor_pre.sh:1`, `tasks/phronesis_monitor_post.py:1` | python3 -m core.heartbeat_loop | `tests/test_card_delivery_closure.py:70`, `tests/test_delivery_and_quiet_hours.py:384`, `tests/test_heartbeat.py:177` | - |
| `heartbeat:provider-canary` | heartbeat-task | **keep** | `HEARTBEAT.md:757` | `tasks/provider_canary_pre.sh:1` | python3 -m core.heartbeat_loop | `tests/test_heartbeat_audit_fixes.py:106`, `tests/test_reliability_v2.py:485` | - |
...
| `heartbeat:repos-sync` | heartbeat-task | **keep** | `HEARTBEAT.md:766` | `tasks/repos_sync_pre.sh:1` | python3 -m core.heartbeat_loop | `tests/test_admin_api.py:325`, `tests/test_card_delivery_closure.py:70`, `tests/test_heartbeat.py:177` | - |
| `heartbeat:routine-run` | heartbeat-task | **keep** | `HEARTBEAT.md:442` | `tasks/routine_run_pre.sh:1`, `tasks/routine_run_post.py:1` | python3 -m core.heartbeat_loop | `tests/test_delivery_and_quiet_hours.py:164`, `tests/test_heartbeat.py:166`, `tests/test_heartbeat_regressions.py:271` | - |
| `heartbeat:self-diagnostic` | heartbeat-task | **keep** | `HEARTBEAT.md:794` | `tasks/self_diagnostic_pre.sh:1`, `tasks/self_diagnostic_post.py:1` | python3 -m core.heartbeat_loop | `tests/test_components_heartbeat_tasks.py:92`, `tests/test_daemon_audit_fixes.py:197`, `tests/test_heartbeat.py:625` | - |
...
| `heartbeat:thinking-review` | heartbeat-task | **keep** | `HEARTBEAT.md:684` | `tasks/thinking_review_post.py:1` | python3 -m core.heartbeat_loop | `tests/test_heartbeat.py:1636` | - |
...
| `cli:core.provider_health` | core-cli | **keep** | `core/provider_health.py:842` | `core/provider_health.py:842` | python3 -m core.provider_health | `tests/test_aux_model.py:101`, `tests/test_heartbeat.py:802`, `tests/test_heartbeat_audit_fixes.py:308` | - |
