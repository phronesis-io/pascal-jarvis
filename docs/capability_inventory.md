...
|---|---|---|---|---|---|---|---|
| `component:admin` | runtime-component | **keep** | `components.yaml:106` | `core/components.py:467` | python3 -m core.components --json | `tests/test_admin.py:51`, `tests/test_admin_api.py:582`, `tests/test_admin_destructive.py:109` | - |
| `component:bot` | runtime-component | **keep** | `components.yaml:45` | `core/components.py:465` | python3 -m core.components --json | `tests/test_components_gating.py:380`, `tests/test_daemon_audit_fixes.py:520`, `tests/test_delegation_verify.py:274` | - |
| `component:caffeinate-launchd` | runtime-component | **keep** | `components.yaml:138` | `core/components.py:474` | python3 -m core.components --json | `tests/test_restart_loop_regression.py:196` | - |
| `component:companion-voice` | runtime-component | **keep** | `components.yaml:161` | `core/components.py:468` | python3 -m core.components --json | `tests/test_companion.py:197` | - |
| `component:conversation-audit` | runtime-component | **keep** | `components.yaml:153` | `core/components.py:471` | python3 -m core.components --json | `tests/test_components_gating.py:128`, `tests/test_reliability_v2.py:27` | - |
| `component:daemon` | runtime-component | **keep** | `components.yaml:38` | `core/components.py:465` | python3 -m core.components --json | `tests/test_admin.py:135`, `tests/test_admin_api.py:352`, `tests/test_anchor_guard.py:84` | - |
| `component:daemon-launchd` | runtime-component | **keep** | `components.yaml:126` | `core/components.py:474` | python3 -m core.components --json | `tests/test_install_flow.py:231`, `tests/test_restart_loop_regression.py:194` | - |
| `component:dashboard` | runtime-component | **keep** | `components.yaml:113` | `core/components.py:467` | python3 -m core.components --json | `tests/test_capability_contracts.py:196`, `tests/test_components_gating.py:43`, `tests/test_daemon_audit_fixes.py:520` | - |
| `component:dashboard-launchd` | runtime-component | **keep** | `components.yaml:120` | `core/components.py:474` | python3 -m core.components --json | `tests/test_install_flow.py:260`, `tests/test_restart_loop_regression.py:73` | - |
| `component:ef-stream` | runtime-component | **keep** | `components.yaml:88` | `core/components.py:469` | python3 -m core.components --json | `tests/test_components_gating.py:29`, `tests/test_daemon_audit_fixes.py:469`, `tests/test_reliability_v2.py:25` | - |
| `component:external-deadman` | runtime-component | **keep** | `components.yaml:132` | `core/components.py:470` | python3 -m core.components --json | `tests/test_deadman.py:82` | - |
| `component:heartbeat-loop` | runtime-component | **keep** | `components.yaml:51` | `core/components.py:466` | python3 -m core.components --json | `tests/test_daemon_audit_fixes.py:520`, `tests/test_deploy.py:35`, `tests/test_iteration_loop.py:936` | - |
| `component:heartbeat-tasks` | runtime-component | **keep** | `components.yaml:58` | `core/components.py:472` | python3 -m core.components --json | `tests/test_components_heartbeat_tasks.py:171` | - |
| `component:lark-sidecar` | runtime-component | **keep** | `components.yaml:98` | `core/components.py:466` | python3 -m core.components --json | `tests/test_components_gating.py:80`, `tests/test_daemon_audit_fixes.py:520`, `tests/test_reliability_v2.py:25` | - |
| `component:session-backup` | runtime-component | **keep** | `components.yaml:145` | `core/components.py:468` | python3 -m core.components --json | `tests/test_reliability_v2.py:26` | - |
| `component:taskline` | runtime-component | **keep** | `components.yaml:33` | `core/components.py:475` | python3 -m core.components --json | `tests/test_components_gating.py:395`, `tests/test_delegation_reconcile.py:196`, `tests/test_install_flow.py:223` | - |
| `component:unified-delivery` | runtime-component | **keep** | `components.yaml:73` | `core/components.py:473` | python3 -m core.components --json | `tests/test_components_gating.py:258` | - |
...
| `heartbeat:eigenflux-friends` | heartbeat-task | **keep** | `HEARTBEAT.md:266` | `tasks/eigenflux_friends_pre.sh:1`, `tasks/eigenflux_friends_post.py:1` | python3 -m core.heartbeat_loop | `tests/test_card_delivery_closure.py:251`, `tests/test_eigenflux_dashboard.py:152`, `tests/test_eigenflux_friend_actions.py:15` | - |
| `heartbeat:eigenflux-preinstall` | heartbeat-task | **keep** | `HEARTBEAT.md:1155` | `tasks/eigenflux_preinstall_pre.sh:1` | python3 -m core.heartbeat_loop | `tests/test_eigenflux_dashboard.py:147`, `tests/test_eigenflux_skill_contracts.py:127` | - |
...
| `heartbeat:exercise-week` | heartbeat-task | **keep** | `HEARTBEAT.md:1270` | `tasks/exercise_week_pre.sh:1`, `tasks/exercise_week_post.py:1` | python3 -m core.heartbeat_loop | `tests/test_lifelog.py:209`, `tests/test_memorial.py:1692` | - |
...
| `heartbeat:personal-site` | heartbeat-task | **keep** | `HEARTBEAT.md:1208` | `tasks/personal_site_pre.sh:1` | python3 -m core.heartbeat_loop | `tests/test_heartbeat.py:1516` | - |
...
| `heartbeat:self-diagnostic` | heartbeat-task | **keep** | `HEARTBEAT.md:1187` | `tasks/self_diagnostic_pre.sh:1`, `tasks/self_diagnostic_post.py:1` | python3 -m core.heartbeat_loop | `tests/test_components_heartbeat_tasks.py:92`, `tests/test_daemon_audit_fixes.py:209`, `tests/test_heartbeat.py:916` | - |
...
| `heartbeat:weekly-review` | heartbeat-task | **keep** | `HEARTBEAT.md:1221` | `tasks/weekly_review_pre.sh:1`, `tasks/weekly_review_post.py:1` | python3 -m core.heartbeat_loop | `tests/test_heartbeat_audit_fixes.py:102`, `tests/test_weekly_review_post.py:48` | - |
...
| `cli:core.components` | core-cli | **keep** | `core/components.py:540` | `core/components.py:540` | python3 -m core.components | `tests/test_companion.py:197`, `tests/test_components_gating.py:35`, `tests/test_components_heartbeat_tasks.py:167` | - |
...
| `cli:core.ef_stream_loop` | core-cli | **keep** | `core/ef_stream_loop.py:810` | `core/ef_stream_loop.py:810` | python3 -m core.ef_stream_loop | `tests/test_components_gating.py:31` | - |
...
| `cli:core.sched_events` | core-cli | **keep** | `core/sched_events.py:286` | `core/sched_events.py:286` | python3 -m core.sched_events | `tests/test_admin_api.py:370`, `tests/test_dashboard_routes.py:313`, `tests/test_heartbeat.py:1278` | - |
...
| `route:page:/eigenflux` | dashboard-page | **keep** | `dashboard/pages/eigenflux.py:216` | `dashboard/pages/eigenflux.py:217` | /eigenflux | `tests/test_capability_contracts.py:185` | - |
