...
| `heartbeat:exercise-week` | heartbeat-task | **keep** | `HEARTBEAT.md:1298` | `tasks/exercise_week_pre.sh:1`, `tasks/exercise_week_post.py:1` | python3 -m core.heartbeat_loop | `tests/test_lifelog.py:210`, `tests/test_memorial.py:1961` | - |
...
| `heartbeat:memory-hourly` | heartbeat-task | **keep** | `HEARTBEAT.md:657` | `tasks/memory_hourly_pre.sh:1`, `tasks/memory_hourly_post.py:1` | python3 -m core.heartbeat_loop | `tests/test_brain_health.py:50`, `tests/test_heartbeat.py:646`, `tests/test_heartbeat_regressions.py:275` | - |
