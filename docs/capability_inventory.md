...
| `heartbeat:daily-plan` | heartbeat-task | **keep** | `HEARTBEAT.md:928` | `tasks/daily_plan_pre.sh:1`, `tasks/daily_plan_post.py:1` | python3 -m core.heartbeat_loop | `tests/test_card.py:176`, `tests/test_daily_plan_post.py:42`, `tests/test_delivery_and_quiet_hours.py:412` | - |
...
| `heartbeat:mail-triage` | heartbeat-task | **keep** | `HEARTBEAT.md:317` | `tasks/mail_triage_pre.sh:1`, `tasks/mail_triage_post.py:1` | python3 -m core.heartbeat_loop | `tests/test_delivery_and_quiet_hours.py:103`, `tests/test_heartbeat.py:107`, `tests/test_heartbeat_loop.py:109` | - |
...
| `heartbeat:phronesis-monitor` | heartbeat-task | **keep** | `HEARTBEAT.md:1003` | `tasks/phronesis_monitor_pre.sh:1`, `tasks/phronesis_monitor_post.py:1` | python3 -m core.heartbeat_loop | `tests/test_card_delivery_closure.py:70`, `tests/test_delivery_and_quiet_hours.py:354` | - |
...
| `cli:core.delivery` | core-cli | **keep** | `core/delivery.py:1515` | `core/delivery.py:1515` | python3 -m core.delivery | `tests/test_admin_api.py:403`, `tests/test_admin_destructive.py:262`, `tests/test_bot_trust_boundary.py:49` | - |
...
| `cli:core.heartbeat_loop` | core-cli | **keep** | `core/heartbeat_loop.py:1898` | `core/heartbeat_loop.py:1898` | python3 -m core.heartbeat_loop | `tests/test_heartbeat_loop.py:74`, `tests/test_import_graph.py:157`, `tests/test_integration.py:67` | - |
...
| `cli:core.lark_auth` | core-cli | **keep** | `core/lark_auth.py:190` | `core/lark_auth.py:190` | python3 -m core.lark_auth | `tests/test_lark_auth.py:75`, `tests/test_reply_followup.py:75` | - |
...
| `cli:core.openai_fallback` | core-cli | **keep** | `core/openai_fallback.py:522` | `core/openai_fallback.py:522` | python3 -m core.openai_fallback | `tests/test_aux_model.py:86`, `tests/test_heartbeat.py:345`, `tests/test_model_fallback.py:278` | - |
...
| `cli:core.provider_health` | core-cli | **keep** | `core/provider_health.py:659` | `core/provider_health.py:659` | python3 -m core.provider_health | `tests/test_dashboard_routes.py:1599`, `tests/test_heartbeat.py:337`, `tests/test_provider_continuity_e2e.py:413` | - |
...
| `lark:eigenflux:publish-confirm` | lark-command | **keep** | `bot.sh:3088` | `bot.sh:3088` | 发 / 不发 | `tests/test_card_delivery_closure.py:222`, `tests/test_eigenflux_dashboard.py:27`, `tests/test_eigenflux_publish_post.py:89` | - |
...
| `lark:memorial:continue` | lark-command | **keep** | `bot.sh:3054` | `bot.sh:3054` | 继续发 / 继续发送 / 发剩下的 | `tests/test_bot_trust_boundary.py:62`, `tests/test_memorial.py:690`, `tests/test_no_dead_ends.py:98` | - |
...
| `lark:session:stop` | lark-command | **keep** | `bot.sh:3125` | `bot.sh:3125` | stop / cancel / 结束 / 停止 | `tests/test_actions.py:237`, `tests/test_admin_api.py:465`, `tests/test_admin_destructive.py:115` | - |
