...
| `heartbeat:eigenflux-preinstall` | heartbeat-task | **keep** | `HEARTBEAT.md:779` | `tasks/eigenflux_preinstall_pre.sh:1` | python3 -m core.heartbeat_loop | `tests/test_eigenflux_skill_contracts.py:136`, `tests/test_heartbeat.py:2121`, `tests/test_interaction_quality_p0.py:228` | - |
...
| `heartbeat:thinking-review` | heartbeat-task | **keep** | `HEARTBEAT.md:684` | `tasks/thinking_review_post.py:1` | python3 -m core.heartbeat_loop | `tests/test_heartbeat.py:1707` | - |
