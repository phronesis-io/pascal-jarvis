...
| `cli:core.delivery` | core-cli | **keep** | `core/delivery.py:1805` | `core/delivery.py:1805` | python3 -m core.delivery | `tests/test_admin_api.py:403`, `tests/test_admin_destructive.py:262`, `tests/test_bot_trust_boundary.py:60` | - |
