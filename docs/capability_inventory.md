...
| `cli:core.prompt` | core-cli | **keep** | `core/prompt.py:561` | `core/prompt.py:561` | python3 -m core.prompt | `tests/test_actions.py:244`, `tests/test_admin.py:68`, `tests/test_admin_destructive.py:347` | - |
