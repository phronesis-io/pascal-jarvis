...
| `heartbeat:eigenflux-preinstall` | heartbeat-task | **keep** | `HEARTBEAT.md:779` | `tasks/eigenflux_preinstall_pre.sh:1` | python3 -m core.heartbeat_loop | `tests/test_eigenflux_skill_contracts.py:136`, `tests/test_heartbeat.py:2213`, `tests/test_interaction_quality_p0.py:228` | - |
...
| `heartbeat:memory-consolidate` | heartbeat-task | **keep** | `HEARTBEAT.md:325` | `tasks/memory_consolidate_pre.sh:1`, `tasks/memory_consolidate_post.py:1` | python3 -m core.heartbeat_loop | `tests/test_cross_session_memory_e2e.py:64`, `tests/test_heartbeat.py:636`, `tests/test_memory_consolidate_post.py:47` | - |
| `heartbeat:memory-daily` | heartbeat-task | **keep** | `HEARTBEAT.md:357` | `tasks/memory_daily_pre.sh:1`, `tasks/memory_daily_post.py:1` | python3 -m core.heartbeat_loop | `tests/test_heartbeat.py:1468`, `tests/test_memory_audit_fixes.py:236` | - |
| `heartbeat:memory-hourly` | heartbeat-task | **keep** | `HEARTBEAT.md:347` | `tasks/memory_hourly_pre.sh:1`, `tasks/memory_hourly_post.py:1` | python3 -m core.heartbeat_loop | `tests/test_brain_health.py:56`, `tests/test_heartbeat.py:1452`, `tests/test_heartbeat_regressions.py:319` | - |
...
| `heartbeat:self-diagnostic` | heartbeat-task | **keep** | `HEARTBEAT.md:794` | `tasks/self_diagnostic_pre.sh:1`, `tasks/self_diagnostic_post.py:1` | python3 -m core.heartbeat_loop | `tests/test_components_heartbeat_tasks.py:92`, `tests/test_daemon_audit_fixes.py:197`, `tests/test_heartbeat.py:654` | - |
...
| `heartbeat:thinking-review` | heartbeat-task | **keep** | `HEARTBEAT.md:684` | `tasks/thinking_review_post.py:1` | python3 -m core.heartbeat_loop | `tests/test_heartbeat.py:1786` | - |
...
| `cli:core.model_fallback` | core-cli | **keep** | `core/model_fallback.py:373` | `core/model_fallback.py:373` | python3 -m core.model_fallback | `tests/test_aux_model.py:20`, `tests/test_heartbeat.py:829`, `tests/test_model_fallback.py:84` | - |
| `cli:core.openai_fallback` | core-cli | **keep** | `core/openai_fallback.py:522` | `core/openai_fallback.py:522` | python3 -m core.openai_fallback | `tests/test_aux_model.py:142`, `tests/test_heartbeat.py:901`, `tests/test_model_fallback.py:298` | - |
...
| `cli:core.provider_health` | core-cli | **keep** | `core/provider_health.py:861` | `core/provider_health.py:861` | python3 -m core.provider_health | `tests/test_aux_model.py:101`, `tests/test_heartbeat.py:831`, `tests/test_heartbeat_audit_fixes.py:308` | - |
...
| `cli:core.sched_events` | core-cli | **keep** | `core/sched_events.py:286` | `core/sched_events.py:286` | python3 -m core.sched_events | `tests/test_absence.py:95`, `tests/test_admin_api.py:370`, `tests/test_heartbeat.py:668` | - |
...
| `lark:eigenflux:publish-confirm` | lark-command | **keep** | `bot.sh:3124` | `bot.sh:3124` | 发 / 不发 | `tests/test_card_delivery_closure.py:222`, `tests/test_eigenflux_publish_post.py:85` | - |
...
| `lark:memorial:continue` | lark-command | **keep** | `bot.sh:3090` | `bot.sh:3090` | 继续发 / 继续发送 / 发剩下的 | `tests/test_bot_trust_boundary.py:73`, `tests/test_memorial.py:698`, `tests/test_no_dead_ends.py:85` | - |
...
| `lark:session:stop` | lark-command | **keep** | `bot.sh:3161` | `bot.sh:3161` | stop / cancel / 结束 / 停止 | `tests/test_actions.py:237`, `tests/test_admin_api.py:465`, `tests/test_admin_destructive.py:115` | - |
