...
| `plans/2026-08-27-codex-frontstage-jarvis-backstage.md` | Active; Phase 0/1 implemented, production acceptance pending | Codex desktop/mobile is the primary interactive frontstage; Jarvis is the continuity and control plane; Lark is bounded wake-up/native integration. The repository has the provider-neutral run protocol and local Codex MCP/plugin connector. Migration remains fail-closed until 20 desktop and 20 mobile journeys pass. |
