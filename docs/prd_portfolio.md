...
| `plans/2026-08-27-codex-frontstage-jarvis-backstage.md` | Active, authoritative product target | Codex desktop/mobile is the primary interactive frontstage; Jarvis is the continuity and control plane; Lark is bounded wake-up/native integration. Defines short Session/long Matter, Context Packet, Result Receipt, independent Model Runtime, retirement rules, measurable progress standards, and a migration sequence that does not claim unshipped behavior. |
