...
MINIMUMS = {
    ...
    "core/matter_executor.py": (80.0, 67.0),
    "core/matter_run_audit.py": (100.0, 100.0),
    "core/matter_run_evidence.py": (87.0, 75.0),
    "core/matter_run_projection.py": (100.0, 100.0),
    "core/matter_runs.py": (82.0, 67.0),
