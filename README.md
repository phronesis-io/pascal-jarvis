...
put the HTTPS ping URL in `JARVIS_DEADMAN_URL` (preferred) or the gitignored
`jarvis.yaml`, and set `ops.deadman.enabled: true`. Never commit the URL.
