...
- Repairs owned child failures before notifying: exact repo-owned
  ...
  `bot.sh` watchdog. Guardian waits for a second failed probe (and a full task-cycle grace for
...
### Dashboard (port 3457) — retired

The NiceGUI dashboard is retired (frozen 2026-08-07, retired 2026-08-21).
Archive duty moved to the morning-anchor batch line and the Admin console;
the shared SQLite store lives on as `core/db.py` (`data/jarvis.db`), and the
code archive is git history.
